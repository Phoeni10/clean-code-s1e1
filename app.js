...
var createNewTaskElement = function (taskString) {
  ...
  checkBox.className = "input-check input";
  editInput.type = "text";
  editInput.className = "input-text incompl-tasks__item input";
...
var taskCompleted = function () {
  ...
  var child = listItem.querySelector(".label");
  child.classList.add("compl-tasks__label");
  console.log(child);
  /* listItem.label = '' */
...
var taskIncomplete = function () {
  ...
  var listItem = this.parentNode;
  var child = listItem.querySelector(".label");
  child.classList.remove("compl-tasks__label");
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
};
